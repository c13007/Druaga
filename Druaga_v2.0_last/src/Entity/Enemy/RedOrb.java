...
public class RedOrb extends Entity{
    ...
    public RedOrb(EntityManager em, int x, int y){
        super(em,13, x, y);
    }
    ...
    public void init() {
        try{
            ImageIcon icon = new ImageIcon(getClass().getResource("/images/entity/red_willo_wisp.png"));
            image = icon.getImage();
	            ...
	            if(em.findFoword(this) == em.getPlayer())
	            	...
	            	if(!moving){
		            	...
		            	if(this.dir == Entity.DOWN){
		            		if(!em.getMap().isHit(x, y, Entity.LEFT)){ this.dir = Entity.LEFT;}
		            		else if(!em.getMap().isHit(x, y, Entity.DOWN)){ this.dir = Entity.DOWN;}
		            		else if(!em.getMap().isHit(x, y, Entity.RIGHT)){ this.dir = Entity.RIGHT;}
		            		else if(!em.getMap().isHit(x,y,Entity.UP)){ this.dir = Entity.UP;}
		            	}else if(this.dir == Entity.UP){
		            		if(!em.getMap().isHit(x, y, Entity.RIGHT)){ this.dir = Entity.RIGHT;}
		            		else if(!em.getMap().isHit(x, y, Entity.UP)){ this.dir = Entity.UP;}
		            		else if(!em.getMap().isHit(x, y, Entity.LEFT)){ this.dir = Entity.LEFT;}
		            		else if(!em.getMap().isHit(x,y,Entity.DOWN)){ this.dir = Entity.DOWN;}
		            	}else if(this.dir == Entity.LEFT){
		            		if(!em.getMap().isHit(x, y, Entity.UP)){ this.dir = Entity.UP;}
		            		else if(!em.getMap().isHit(x, y, Entity.LEFT)){ this.dir = Entity.LEFT;}
		            		else if(!em.getMap().isHit(x, y, Entity.DOWN)){ this.dir = Entity.DOWN;}
		            		else if(!em.getMap().isHit(x,y,Entity.RIGHT)){ this.dir = Entity.RIGHT;}
		            	}else if(this.dir == Entity.RIGHT){
		            		if(!em.getMap().isHit(x, y, Entity.DOWN)){ this.dir = Entity.DOWN;}
		            		else if(!em.getMap().isHit(x, y, Entity.RIGHT)){ this.dir = Entity.RIGHT;}
		            		else if(!em.getMap().isHit(x, y, Entity.UP)){ this.dir = Entity.UP;}
		            		else if(!em.getMap().isHit(x,y,Entity.LEFT)){ this.dir = Entity.LEFT;}
		            	}
