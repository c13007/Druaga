...
public class DruidGhost extends Entity{
    
    Random rand;
    private LOS los;
    private Position positionOld;
    
    public DruidGhost(EntityManager em, int x, int y){
        super(em, 8, x, y);
        los = new LOS(em,x,y);
    ...
    public void init() {
        try{
            ImageIcon icon = new ImageIcon(getClass().getResource("/images/entity/druidghost.png"));
            image = icon.getImage();
